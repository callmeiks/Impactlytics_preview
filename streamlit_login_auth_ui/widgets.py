...
class __login__:
    ...
    def nav_sidebar(self):
        ...
        with main_page_sidebar:
            selected_option = option_menu(
                ...
                icons=['book','calculator', 'box-arrow-in-right', 'person-plus', 'x-circle', 'key', 'shield-lock', 'shield-check'],
                options=["README", "Math Modeling", 'Login', 'Create Account', 'Forgot Password?',"Privacy Policy", "Terms of Use"],
                styles={
    ...
    def build_login_ui(self):
        ...
        if selected_option == 'Login':
            st.title("🚀 Impactlytics staff dashboard")

            st.markdown("---")
            st.caption("Powered by Streamlit · Built with ❤️ by Team Impactlytics")
        ...
        if selected_option == "Math Modeling":
            ...
            with open("markdown/privacy_policy.md", "r", encoding="utf-8") as file:
                st.markdown(file.read())
        elif selected_option == "Terms of Use":
            with open("markdown/terms_of_use.md", "r", encoding="utf-8") as file:
                st.markdown(file.read())
